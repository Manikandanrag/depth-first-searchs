...
n, e = map(int, input("Enter number of nodes and edges (e.g., 5 4): ").split())

print("Enter each edge as two node labels separated by space (e.g., A B):")
for i in range(e):
...
##OUTPUT1:
<img width="970" height="465" alt="image" src="https://github.com/user-attachments/assets/4ff01d90-2b08-4785-b8a3-ff8258a36e3f" />

##OUTPUT2:
<img width="970" height="465" alt="image" src="https://github.com/user-attachments/assets/c5bb0873-fed8-47f1-a6f3-68de503d031f" />
